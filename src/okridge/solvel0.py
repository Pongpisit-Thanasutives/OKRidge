...
def okridge_solvel0(X, y, k, lambda2=1e-5, gap_tol=1e-5, useBruteForce=True, time_limit=180, verbose=False):
...
def okridge_solvel0_full(X, y, k, lambda2=1e-5, gap_tol=1e-5, useBruteForce=True, time_limit=180, verbose=False):
    BnB_optimizer = BNBTree(X=X, y=y.flatten(), lambda2=lambda2, useBruteForce=useBruteForce, verbose=verbose)
